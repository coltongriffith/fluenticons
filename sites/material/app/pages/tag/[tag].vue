<template>
  <div class="container mx-auto px-4 sm:px-8 py-8">
    ...
    <p class="text-gray-600 dark:text-gray-300 mb-8 max-w-3xl">
      {{ icons.length }} Material Symbols that Google tags “{{ data.name }}”. Open any icon to
...
const description = `${icons.value.length} free ${data.value.name} icons from Google's Material Symbols. Download SVG or PNG in every style and weight, or copy HTML, React and Flutter code.`;
