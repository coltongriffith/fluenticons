<template>
  <main>
    <section class="py-16 prose dark:prose-invert mx-auto">
      ...
      <h3>Advertising</h3>
      <p>
        We use Google AdSense to show advertisements on the Service. Third party
      ...
      <p>
        ...
        <a
          ...
          target="_blank"
          rel="noopener"
          >How Google uses information from sites or apps that use its services</a
        >.
      </p>
      <h3>Analytics</h3>
      <p>
        We use Google Analytics to understand how the Service is used. Google
        Analytics collects Usage Data such as pages visited and device
        information using cookies. You can prevent this by installing the
        <a
...
<script setup>
useHead({ title: "Privacy Policy | Fluenticons" });
</script>
