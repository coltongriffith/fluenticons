<template>
    <svg  width="24" height="24" fill="none" xmlns="http://www.w3.org/2000/svg" id="mdi-chart-multiline" viewBox="0 0 24 24">
    <linearGradient
      v-if="fill === 'url(#g1)'"
      id="g1"
...
export default {
      name: 'MaterialIconFilledChartMultiline.svg',
  mixins: [icon]
};
</script>