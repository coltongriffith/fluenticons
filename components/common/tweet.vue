<template>
  <a
    class="flex items-center space-x-2 absolute top-2 left-2"
    target="_blank"
    rel="noopener"
    href="https://twitter.com/intent/tweet?text=Check%20out%20Fluent%20Icons!%20%F0%9F%94%A5%0A%0AThanks%20%40MicrosoftDesign%20for%20Fluenticons%20and%20%40fayazara%20for%20fluenticons.co!"
  >
    <svg
      viewBox="0 0 36 36"
    ...
    <span>Tweet thank you on Twitter!</span>
  </a>
</template>
