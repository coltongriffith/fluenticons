<template>
  <a href="https://fayazz.co/coffee" target="_blank" rel="noopener">
    <div
      class="flex items-center justify-center space-x-2 mr-2 text-gray-800 dark:text-white"
    >
      <svg
      ...
      <h3 class="text-xs sm:text-base md:text-base lg:text-base xl:text-base">
        Buy me coffee?
      </h3>
    </div>
  </a>
