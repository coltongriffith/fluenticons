...
<path d="M10.25 14a.75.75 0 0 0 0 1.5h3.5a.75.75 0 0 0 0-1.5h-3.5ZM8.75 6a.75.75 0 0 0-.75.75v4.5c0 .415.336.75.75.75h6.5a.75.75 0 0 0 .75-.75v-4.5a.75.75 0 0 0-.75-.75h-6.5Zm.75 4.5v-3h5v3h-5Z" :fill="fill" :fill-opacity="opacity" />
...
export default {
    name: 'FluentIconOutlinedWalkieTalkie',
    mixins: [icon]
};
</script>