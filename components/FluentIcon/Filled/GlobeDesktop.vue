...
<path d="M12 14a1 1 0 0 1 1-1h9a1 1 0 0 1 1 1v5a1 1 0 0 1-1 1h-3v2h.5a.5.5 0 0 1 0 1h-4a.5.5 0 0 1 0-1h.5v-2h-3a1 1 0 0 1-1-1v-5Z" :fill="fill" :fill-opacity="opacity" /></svg>
</template>
...
export default {
    name: 'FluentIconFilledGlobeDesktop',
    mixins: [icon]
};
</script>