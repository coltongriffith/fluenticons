...
<path d="M11.978 9.98h1.49l-.362 1.586H11.59l.388-1.586Z" :fill="fill" :fill-opacity="opacity" />
<linearGradient v-if="fill === 'url(#g1)'" id="g1" :gradientTransform="`rotate(${angle})`">
      <stop class="main-stop" offset="0%" :stop-color="start" />
      <stop class="alt-stop" offset="100%" :stop-color="end" />
    </linearGradient>
...
export default {
    name: 'FluentIconFilledBookNumber',
    mixins: [icon]
};
</script>